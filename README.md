...
GPT Image2 这类模型生成的 UI 效果图观感确实很不错，但直接丢给 Codex 或者其他大模型做代码还原，输出效果往往惨不忍睹。尤其原图里大量混杂切图素材时，AI 编码很难自动区分哪些元素可以用代码原生实现、哪些只能作为静态切图。
...
- 在Vibe Coding 中基于GPT Image2 等模型生成的 UI 图后二次开发。
